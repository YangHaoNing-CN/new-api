...
var defaultModelDescriptions = map[string]string{
	...
	// ========== 图片模型 ==========
	"wanx2.1-t2i-turbo":       "万相2.1极速版文生图，按张计费",
	"wanx2.1-t2i-plus":        "万相2.1专业版文生图，按张计费",
	"wanx-v1":                 "通义万相文生图，按张计费",
	"wanx-style-repaint-v1":   "涂鸦作画/风格重绘，按张计费",
	"wanx-sketch-to-image-v1": "线稿生成图像，按张计费",
	"flux-schnell":            "FLUX极速版文生图，按张计费",
	"flux-dev":                "FLUX开发版文生图，按张计费",
	"flux-merged":             "FLUX融合版文生图，按张计费",
	// ========== Embedding & Rerank ==========
